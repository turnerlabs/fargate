...
You can install the CLI with a curl utility script or by downloading the binary from the [releases](releases) page. Once installed you'll get the `fargate` command.
